#!/sbin/python
# Last modified: 2025-04-11 12:48
# this file: MT-geosupport-example-code.py

## NOTE: Be sure to set environment variables first. If you are running the script on the command line, use the wrapper script and uncomment the line that calls this script at the end of the wrapper script.
## NOTE: If you are running this script interactively, you have set the GEOFILES and LD_LIBRARY_PATH environment variables set BEFORE you start python, using ye olde export command:
...
print("MT-geosupport-example-code.py: This script has a bunch of geosupport example code (maybe best run interactively, and reading the comments). Environmental variables must be set before running.")
print(" ")
